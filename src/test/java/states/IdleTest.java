...
@DisplayName("Tests de l'état Inactif (Idle)")
class IdleTest {
	...
	// code
	@Test
	@DisplayName("Test du Singleton pour IdleTimer")
	...
	@Test
	@DisplayName("Test de l'absence de transition sur UP (mémoire à 0)")
	...
	@Test
	@DisplayName("Test de transition vers ActiveTimer sur UP (mémoire > 0)")
	...
	@Test
	@DisplayName("Test de transition vers SetTimer sur RIGHT")
	void testRight() {
